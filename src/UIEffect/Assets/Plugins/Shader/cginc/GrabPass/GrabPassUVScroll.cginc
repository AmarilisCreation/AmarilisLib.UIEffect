...
half4 frag(v2f IN) : SV_Target
{
    ...
    float scroll = parameter.g;
    float strength = parameter.b;
    float blend = 2.0 * parameter.a - 1.0;
    ...
    half4 resultColor = grabColor + uvScrollColor * uvScrollColor.a * strength * blend;
